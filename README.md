...
> **Hackathon'26 submission:** this fork's project is the [Data-Centre Siting & Cooling-Cost Engine](docs/dc_siting_cooling_cost_engine.md) — turns FortyGuard's hyperlocal temperature data into the dollar cost difference between candidate data-centre sites and cooling architectures. Run it with `streamlit run app.py`, or read the [full writeup](docs/dc_siting_cooling_cost_engine.md).
